...
void Game0()
{
	...
	///anbar
	 else if(CSLeft_R>=200 && CSLeft_R<=255 && CSLeft_G>=80 && CSLeft_G<=110 && CSLeft_B>=0 && CSLeft_B<=10 & anbar>2)
    {
        Duration = 41;
        CurAction =1;
		anbar=0;
	...
	///color
    else if(CSLeft_R>=0 && CSLeft_R<=80 && CSLeft_G>=0 && CSLeft_G<=80 && CSLeft_B>=0 && CSLeft_B<=80 && anbar<=6)
    {
        Duration = 44;
        CurAction =5;
		anbar++;
    }
    else if(CSRight_R>=0 && CSRight_R<=80 && CSRight_G>=0 && CSRight_G<=80 && CSRight_B>=0 && CSRight_B<=80 && anbar<=6)
    {
        Duration = 44;
        CurAction =5;
		anbar++;
	...
	///color
    else if(CSLeft_R>=0 && CSLeft_R<=55 && CSLeft_B>=0 && CSLeft_B<=55 && anbar<=6)
    {
        Duration = 44;
        CurAction =5;
		anbar++;
    }
    else if(CSRight_R>=0 && CSRight_R<=55 && CSRight_B>=0 && CSRight_B<=55 && anbar<=6)
    {
        Duration = 44;
        CurAction =5;
		anbar++;
	...
	///color
    else if(CSLeft_R>=200 && CSLeft_R<=255 && CSLeft_G>=0 && CSLeft_G<=55 && CSLeft_B>=0 && CSLeft_B<=55 && anbar<=6)
    {
        Duration = 44;
        CurAction =5;
		anbar++;
    }
    else if(CSRight_R>=200 && CSRight_R<=255 && CSRight_G>=0 && CSRight_G<=55 && CSRight_B>=0 && CSRight_B<=55 && anbar<=6)
    {
        Duration = 44;
        CurAction =5;
		anbar++;
...
///////////SuperObj
     ...
     if(f==2 && s>= 35 )
	{
	 ...
	 if((Compass1 + 3) >= Compass) &&( Compass >= (Compass1 - 3) && f==1)
	{
		f=2;
	}
	
	 if(((Compass>=(Compass1 + 4)) ||(Compass<=(Compass1 - 4))) && f==1)
	{
		            Duration=0;
					CurAction=2020;
	...
	///trap
	else if (sqrt((Y-135)^2 + (X-78)^2) <= 23 )
	{
		f=1;
		if ( o==0)
		{
	...
	///trap
	else if (sqrt((Y-135)^2 + (X-275)^2) <= 23 )
	{
		f=1;
		if ( o==0)
		{
	...
	///silver
	else if (sqrt((Y-10)^2 + (X-245)^2) >= 78 )
	{
		f=1;
		if ( o==0)
		{
	...
	//tree
	else if (sqrt((Y-190)^2 + (X-135)^2) >= 20 )
	{
		f=1;
		if ( o==0)
		{
	...
	else if((Compass1 + 3) >= Compass) &&( Compass >= (Compass1 - 3) && f==1)
	{
		f=2;
	}
	
	else if(((Compass>=(Compass1 + 4)) ||(Compass<=(Compass1 - 4))) && f==1)
	{
		            Duration=0;
					CurAction=2020;
